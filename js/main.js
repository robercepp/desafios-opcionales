...
function MENUPRINCIPAL() {
    ...
    contenido.innerHTML = "Bienvenido/a al simulador de tienda, aquí podrás ver mi catálogo de items en venta.<br />Por favor elige una opción:<br />1-Buscar Item<br />2-Libretas<br />3-Stickers<br />4-Posters<br />5-Ir al carrito de compras<br />6-Salir";
...
function MENUBUSQUEDA() {
    ...
    contenido.innerHTML = "---Buscador de Productos---<br />Escriba el tipo o el nombre del ítem que esté buscando.<br />Pista: puede ser un tipo como 'Sticker' o 'Poster', o alguna palabra clave.<br />Escriba '0' para volver al menú principal.";
...
function MENU(clase, tipoPlural) {
    ...
    enumerador((lista) => {
        conteo.push(numeracion + "- " + lista.nombre + ",<br/> Precio: $" + lista.precio + ", Stock: " + lista.stock + ".");
    }, lista);
    titulo.innerHTML = "---Menu de " + tipoPlural + "---";
    contenido.innerHTML = "Por favor elija una opción para agregar al carrito: <br/><br/>" + conteo.join("<br />") + "<br/>0- Volver al menú anterior.<br/> <br/>Nota: Los precios no incluyen i.v.a."
    window.setTimeout(OPCION, 0);
                    ...
                    if (catalogoDeBusqueda[lista[(menuOpcion - 1)].id].stock >= cantidades) {
                        if (cantidades >= 1) {
                            ...
                            if (cantidades == 1) {
                                ...
                                window.setTimeout(MENU(clase, tipoPlural), 0);
                            } else {
...
function MENUCARRITO() {
    ...
    contenido.innerHTML = "Repasemos lo que has cargado en el carrito antes de confirmar...<br/><br/>La cantidad de Items son: " + cantidadProductos + "<br/>Un resumen de los Items que pediste:<br/>" + listadoCarrito + "<br/>El costo total (Incluyendo IVA) es de: $" + (precioConIva.toFixed(2) + "-.") + "<br/>Elige una opción:<br/>1-Pagar monto.<br/>2-Quitar elementos del carrito.<br/>3-Volver atrás.<br/>4-Cancelar compra."
    window.setTimeout(OPCION, 0);
...
function QUITARELEMENTOS() {
    ...
    titulo.innerHTML = "---Quitar Elementos del Carrito---"
    contenido.innerHTML = "Los Ítems cargados en el carrito de compras:<br />" + conteo.join("<br />") + "<br />Elija el Ítem que desea eliminar<br />0- para volver al menú anterior."
    window.setTimeout(OPCION, 0);
...
function CIERREDECOMPRA() {
    ...
    const precioConIva = precioSinIva * iva;
    contenido.innerHTML = "Por favor introduzca a continuación un correo electrónico para poder enviarte los productos."
